              ...
              <Card key={i} className="border border-slate-200 shadow-sm">
                <CardBody className="p-6">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-4 md:grid-cols-4">
                    {[1, 2, 3, 4].map((j) => (
                      <div key={j} className="rounded-lg bg-slate-100 p-3 text-center">
                        <div className="h-3 bg-slate-200 rounded animate-pulse w-16 mx-auto mb-2"></div>
                        <div className="h-8 bg-slate-200 rounded animate-pulse w-12 mx-auto"></div>
                      </div>
                    ))}
                  </div>
                </CardBody>
