...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-[60px] md:pt-[100px] pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-gray-400 my-4 max-w-md">
              ...
              Practice with quality questions and track your progress.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">terrahconnects@gmail.com</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">
            © {currentYear} Terrah Qbank. All rights reserved.
          </p>
          <p className="text-sm text-gray-400 mt-2 md:mt-0">
            Made with Love for exam aspirants
          </p>
        </div>
      </div>
    </footer>
